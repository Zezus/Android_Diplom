...
public class NoteActivity extends AppCompatActivity implements ListFragment.Callback, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.main_content_note);
        navigationView = findViewById(R.id.nav_view_note);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.item_schedule:
                i = new Intent(NoteActivity.this, ScheduleActivity.class);
                startActivity(i);
                break;

            case R.id.item_timer:
                i = new Intent(NoteActivity.this, TimerActivity.class);
                startActivity(i);
                break;

            case R.id.item_object:
                i = new Intent(NoteActivity.this, ObjectActivity.class);
                startActivity(i);
                break;

            case R.id.item_homework:
                i = new Intent(NoteActivity.this, HomeWorkActivity.class);
                startActivity(i);
                break;

            case R.id.item_grade:
                i = new Intent(NoteActivity.this, GradeActivity.class);
                startActivity(i);
                break;

            case R.id.item_note:
                i = new Intent(NoteActivity.this, NoteActivity.class);
                startActivity(i);
                break;

            case R.id.item_wikipedia:
                i = new Intent(NoteActivity.this, WikipediaActivity.class);
                startActivity(i);
                break;

            case R.id.item_walfram:
                i = new Intent(NoteActivity.this, WolframActivity.class);
                startActivity(i);
                break;
    ...
    public void changeFragmentClicked(View view, Item item) {
        ...
        if (item.getTitle() == "Расписание") {
            Intent intent = new Intent();
            intent.setClass(NoteActivity.this, ScheduleActivity.class);
            startActivity(intent);
        } else if (item.getTitle() == "Таймер для выполнения \n\tдомашнего задания") {
            Intent intent = new Intent();
            intent.setClass(NoteActivity.this, TimerActivity.class);
            startActivity(intent);
        } else if (item.getTitle() == "Предметы и \n\tпреподаватели") {
            Intent intent = new Intent();
            intent.setClass(NoteActivity.this, ObjectActivity.class);
            startActivity(intent);
        } else if (item.getTitle() == "Домашнее задание") {
            Intent intent = new Intent();
            intent.setClass(NoteActivity.this, HomeWorkActivity.class);
            startActivity(intent);
        } else if (item.getTitle() == "Оценки") {
            Intent intent = new Intent();
            intent.setClass(NoteActivity.this, GradeActivity.class);
            startActivity(intent);
        } else if (item.getTitle() == "Записи") {
            Intent intent = new Intent();
            intent.setClass(NoteActivity.this, NoteActivity.class);
            startActivity(intent);
        } else if (item.getTitle() == "Wolfram Alpha") {
            Intent intent = new Intent();
            intent.setClass(NoteActivity.this, WolframActivity.class);
            startActivity(intent);
        } else if (item.getTitle() == "Wikipedia") {
            Intent intent = new Intent();
            intent.setClass(NoteActivity.this, WikipediaActivity.class);
            startActivity(intent);
        }
        transaction.commit();
